"use client"; // wajib biar Firebase jalan di browser
      ...
      <div className="w-full max-w-md mx-auto z-10">
        ...
        <div className="bg-slate-900/70 backdrop-blur-xl border border-slate-700 p-8 md:p-12 rounded-2xl shadow-lg text-center">
            ...
            <button
                ...
                className="w-full inline-flex justify-center items-center gap-4 bg-slate-800 border border-slate-700 hover:border-slate-500 rounded-lg px-6 py-3 text-md font-medium text-white transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 focus:ring-indigo-500"
            >
                <GoogleIcon />
