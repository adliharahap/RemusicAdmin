        ...
        <div className="overflow-x-auto">
          <table className="min-w-full text-sm">
            <thead className="bg-slate-50 dark:bg-slate-950/50 border-b border-slate-200 dark:border-slate-800">
              <tr>
                <th className="py-4 px-6 text-left font-semibold text-slate-500 dark:text-slate-400">#</th>
                <th className="py-4 px-6 text-left font-semibold text-slate-500 dark:text-slate-400">Lagu</th>
                <th className="py-4 px-6 text-left font-semibold text-slate-500 dark:text-slate-400">Artis</th>
                <th className="py-4 px-6 text-left font-semibold text-slate-500 dark:text-slate-400">Statistik</th>
                <th className="py-4 px-6 text-left font-semibold text-slate-500 dark:text-slate-400">Durasi</th>
                <th className="py-4 px-6 text-left font-semibold text-slate-500 dark:text-slate-400">Tanggal</th>
                <th className="py-4 px-6 text-right font-semibold text-slate-500 dark:text-slate-400">Aksi</th>
              </tr>
            </thead>
                  ...
                  >
                    ...
                    <td className="py-4 px-6">
                      <div className="flex flex-col gap-1 text-xs font-medium">
                        ...
                        <span className="text-indigo-600 dark:text-indigo-400 flex items-center gap-1">▶ {formatNumber(song.play_count)}</span>
                        <span className="text-rose-600 dark:text-rose-400 flex items-center gap-1">♥ {formatNumber(song.like_count)}</span>
                      </div>
                    </td>
                ...
                <tr>
                  <td colSpan="7" className="text-center py-24">
                    <div className="flex flex-col items-center justify-center text-slate-500">
                      ...
                      <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-300">Belum ada lagu</h3>
      ...
      <div className="flex items-center justify-between border-t border-slate-200 dark:border-slate-800 pt-4 px-1">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="p-2 rounded-lg border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-400 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
          >
